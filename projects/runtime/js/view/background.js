    ...
    window.opspark.makeBackground = function(app,ground) {
        ...
        function render() {
           ...
           /* for(var i = 0; i < 100; i++){
            ...
            moon.y = groundY - 399; // creates an y key for the moon object and assigns it a value of 200
          ...
          var buildingHeights = [300, 150, 175, 200];  // creates a array of buildingHeight and stores 300 as the height of the building
          ...
          for (var i = 0; i < buildingHeights.length; i++) {
            ...
            tree.y = groundY - 120; // sets the y value of the tree
